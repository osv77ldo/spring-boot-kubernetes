            ...
            steps{
        		...
        		script{
        		   ...
        		   env.DOCKER_EXEC = "${DOCKER}/bin/docker"
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:0.0.0.0" -v $(pwd):/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-baseline.py -t "https://demo.testfire.net/" -I -r zap_baseline_report.html -l PASS'	
